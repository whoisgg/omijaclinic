      ...
      >
        ...
        <div className="relative z-10 w-full px-6 md:px-12 lg:px-24">
          <div className="max-w-4xl" style={{ perspective: "1000px" }}>
            <span className="text-[#C5A059] font-bold tracking-widest uppercase text-xs mb-4 block">Tratamientos</span>
            <h1
              ref={titleRef}
            ...
            <p ref={subtitleRef} className="text-stone-200/80 text-lg md:text-xl font-light leading-relaxed max-w-2xl">
              Descubra nuestros pilares de cuidado integral, donde la tecnología avanzada se combina con un enfoque minimalista y humano.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center group">
          ...
          <div className="flex flex-col gap-6 order-1 lg:order-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-bold text-[#C5A059] uppercase tracking-[0.2em]">General</span>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center group">
          ...
          <div className="flex flex-col gap-6 order-1">
            <div className="flex items-center gap-3">
              ...
              <div className="h-px w-8 bg-[#C5A059]"></div>
              <span className="text-xs font-bold text-[#C5A059] uppercase tracking-[0.2em]">Especialidad</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-zinc-900 tracking-tight">
              Endodoncia Avanzada
            </h2>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center group">
          ...
          <div className="flex flex-col gap-6 order-1 lg:order-2">
            <div className="flex items-center gap-3">
              ...
              <div className="h-px w-8 bg-[#C5A059]"></div>
              <span className="text-xs font-bold text-[#C5A059] uppercase tracking-[0.2em]">Belleza</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-zinc-900 tracking-tight">Estética Dental</h2>
            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
      ...
      <section className="py-24 md:py-32 px-6 md:px-8 lg:px-12 bg-zinc-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#"
              className="w-full sm:w-auto px-8 py-4 bg-[#C5A059] hover:bg-[#B08F4A] text-white font-bold rounded-lg transition-all duration-300 text-center"
            >
              Agendar Cita
            </a>
            <a
              href="#"
              className="w-full sm:w-auto px-8 py-4 bg-transparent border-2 border-gray-600 text-white font-bold rounded-lg hover:bg-white/10 hover:border-white transition-all duration-300 text-center"
            >
              Contactar Soporte
            </a>
          </div>
